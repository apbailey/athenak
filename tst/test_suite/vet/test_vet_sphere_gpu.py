"""
VET transport test (level 2): homogeneous emitting/absorbing sphere convergence ladder.

Runs the vet_sphere problem generator (a uniform emitting/absorbing sphere in vacuum) over a
...
error) and appends the relative L2 (RMS-L1 column) and L-infty errors to vet_sphere-errs.dat.
...
def test_vet_sphere(ndim):
    input_file = "inputs/vet_sphere.athinput"
    ...
    try:
        ...
        data = testutils.athena_read.error_dat("vet_sphere-errs.dat")
